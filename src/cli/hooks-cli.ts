...
export function registerHooksCli(program: Command) {
  ...
  gmail
    .command("setup")
    .description("Configure Gmail watch + Pub/Sub + Farm Friend Terminal hooks")
    ...
    .option("--hook-url <url>", "Farm Friend Terminal hook URL")
    .option("--hook-token <token>", "Farm Friend Terminal hook token")
