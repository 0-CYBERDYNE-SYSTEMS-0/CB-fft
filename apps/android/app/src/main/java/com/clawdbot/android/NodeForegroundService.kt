...
class NodeForegroundService : Service() {
  ...
  override fun onCreate() {
    super.onCreate()
    ensureChannel()
    val initial = buildNotification(title = "Farm Friend Terminal Node", text = "Starting…")
    ...
    notificationJob =
      scope.launch {
        combine(
          ...
          val title =
            if (connected) "Farm Friend Terminal Node · Connected"
            else "Farm Friend Terminal Node"
          val voiceSuffix =
  ...
  private fun ensureChannel() {
    ...
    val channel =
      NotificationChannel(
        ...
        description = "Farm Friend Terminal node connection status"
        setShowBadge(false)
      }
